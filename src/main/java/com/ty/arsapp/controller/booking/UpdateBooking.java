...
@WebServlet(value = "/updateBooking")
public class UpdateBooking extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Booking booking2 = bookingServiceImp.updateBooking(booking, id);
		...
		if (booking2 != null) {
			...
			if (booking3 != null) {
				...
				RequestDispatcher requestDispatcher = req.getRequestDispatcher("viewBookingByUser");
				requestDispatcher.forward(req, resp);
			} else {
				resp.sendRedirect("searchFlight.jsp");
			}
		} else {
			resp.sendRedirect("updateBooking.jsp");
		}
	} 
