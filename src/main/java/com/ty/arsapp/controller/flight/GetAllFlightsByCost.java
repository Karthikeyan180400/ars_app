...
@WebServlet(value = "/getAllFlightsByCost")
public class GetAllFlightsByCost extends HttpServlet {
	@Override
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<Flight> flights = flightServiceImp.getAllFlightsByCost(cost);
		if (flights.size() > 0) {
			req.setAttribute("flightsList", flights);
			RequestDispatcher requestDispatcher = req.getRequestDispatcher("viewFlightsByCost.jsp");
